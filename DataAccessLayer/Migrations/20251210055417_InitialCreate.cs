    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6148), "admin@fpt.edu.vn", "Administrator", false, "System Administrator", "1", "Administrator", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6152), "anh@fpt.edu.vn", "Nguyen Van Anh", false, "Ngôn Ngữ Anh", "1", "Student", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6155), "bao@fpt.edu.vn", "Nguyen Van Bao", false, "Ngôn Ngữ Anh", "1", "Student", null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6157), "cam@fpt.edu.vn", "Le Thi Cam", false, "Quản Trị Kinh Doanh", "1", "Student", null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6159), "duc@fpt.edu.vn", "Tran Minh Duc", false, "Quản Trị Kinh Doanh", "1", "Student", null },
                    { new Guid("66666666-6666-6666-6666-666666666666"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6162), "huy@fpt.edu.vn", "Pham Quoc Huy", false, "Kỹ Thuật Phần Mềm", "1", "Student", null },
                    { new Guid("77777777-7777-7777-7777-777777777777"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6165), "khanh@fpt.edu.vn", "Vo Thi Khanh", false, "Kỹ Thuật Phần Mềm", "1", "Student", null },
                    { new Guid("88888888-8888-8888-8888-888888888888"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6167), "lam@fpt.edu.vn", "Nguyen Hoang Lam", false, "Kỹ Thuật Phần Mềm", "1", "Student", null },
                    { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6169), "my@fpt.edu.vn", "Tran Thi My", false, "Kỹ Thuật Phần Mềm", "1", "Student", null },
                    { new Guid("aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6171), "son.instructor@fpt.edu.vn", "Pham Thanh Son", false, "Teacher", "1", "Instructor", null },
                    { new Guid("aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6173), "ha.instructor@fpt.edu.vn", "Le Thi Ha", false, "Teacher", "1", "Instructor", null },
                    { new Guid("bbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbb1"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6204), "tri.committee@fpt.edu.vn", "Nguyen Minh Tri", false, "Teacher", "1", "GraduationProjectEvaluationCommitteeMember", null },
                    { new Guid("bbbbbbb2-bbbb-bbbb-bbbb-bbbbbbbbbbb2"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6206), "thu.committee@fpt.edu.vn", "Tran Hoai Thu", false, "Teacher", "1", "GraduationProjectEvaluationCommitteeMember", null },
                    { new Guid("bbbbbbb3-bbbb-bbbb-bbbb-bbbbbbbbbbb3"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6209), "duy.committee@fpt.edu.vn", "Vo Quoc Duy", false, "Teacher", "1", "GraduationProjectEvaluationCommitteeMember", null },
                    { new Guid("bbbbbbb4-bbbb-bbbb-bbbb-bbbbbbbbbbb4"), new DateTime(2025, 12, 10, 5, 54, 17, 167, DateTimeKind.Utc).AddTicks(6211), "yen.committee@fpt.edu.vn", "Pham Thi Yen", false, "Teacher", "1", "GraduationProjectEvaluationCommitteeMember", null }
                });

            migrationBuilder.InsertData(
                table: "Topics",
                columns: new[] { "Id", "Created_By", "Deadline_Date", "Description", "Is_Group_Required", "Major", "Semester_Id", "Title" },
                values: new object[,]
                {
                    { 1, new Guid("aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Đo lường vốn từ vựng phái sinh của sinh viên học tiếng Anh như một ngoại ngữ bằng bài kiểm tra không có ngữ cảnh", false, "Ngôn Ngữ Anh", 1, "Measuring Vietnamese EFL learners’ productive derivative knowledge in a decontextualized test format" },
                    { 2, new Guid("aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gọi ngẫu nhiên, làm việc nhóm và kiểm tra trắc nghiệm trực tuyến trong vai trò dự báo lo âu trong lớp học tiếng Anh dự bị (ENT) tại Trường Đại học FPT", false, "Ngôn Ngữ Anh", 1, "Predictors of Classroom Anxiety in General English (ENT) classes at FPT University" },
                    { 3, new Guid("aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "HomePlus - Cổng dịch vụ sống thông minh cho cư dân", true, "Kỹ Thuật Phần Mềm", 1, "HomePlus- Smart Living Services Portal for Apartment Residents" }
                });
